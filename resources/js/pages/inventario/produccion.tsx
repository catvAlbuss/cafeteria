            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 bg-[#FBF7F0]">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                        <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-lg">🟠 Pendientes: {contarPorEstado('pendiente')}</span>
                        <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-lg">🔵 Preparando: {contarPorEstado('preparando')}</span>
                        <span className="px-3 py-1 bg-green-100 text-green-600 rounded-lg">🟢 Listos: {contarPorEstado('listo')}</span>
                    </div>
                </div>
