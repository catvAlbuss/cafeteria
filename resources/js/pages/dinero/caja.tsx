...
const ProductImage = ({
    ...
    // ============================================================
    // COMPONENTE: Tarjeta de Categoría MODERNA - TAMAÑO REDUCIDO
    // ============================================================
    const CategoriaCard = ({
        categoria,
        icon: IconComponent,
        ...
        return (
            <div
                onClick={onClick}
                className={`rounded-xl p-3 cursor-pointer transition-all duration-300 group ${isActive
    ...
    export default function Caja() {
        ...
        const [productos] = useState<Producto[]>([
            // Café
            { id: 1, nombre: 'Espresso', precio: 4.20, categoria: 'Café', imagen: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500', stock: 10, disponible: true },
            { id: 2, nombre: 'Cappuccino', precio: 6.50, categoria: 'Café', imagen: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500', stock: 8, disponible: true },
            { id: 3, nombre: 'Latte', precio: 5.80, categoria: 'Café', imagen: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500', stock: 5, disponible: true },
            { id: 4, nombre: 'Americano', precio: 5.00, categoria: 'Café', imagen: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=500', stock: 3, disponible: true },
            { id: 7, nombre: 'Flat White', precio: 6.20, categoria: 'Café', imagen: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=500', stock: 6, disponible: true },

            // Té
            { id: 9, nombre: 'Té Verde', precio: 4.50, categoria: 'Té', imagen: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=500', stock: 12, disponible: true },
            { id: 10, nombre: 'Té Negro', precio: 4.00, categoria: 'Té', imagen: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=500', stock: 15, disponible: true },
            { id: 11, nombre: 'Té de Manzanilla', precio: 4.80, categoria: 'Té', imagen: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=500', stock: 8, disponible: true },
            { id: 12, nombre: 'Té Chai', precio: 5.50, categoria: 'Té', imagen: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=500', stock: 4, disponible: true },
            { id: 13, nombre: 'Té de Menta', precio: 4.30, categoria: 'Té', imagen: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=500', stock: 6, disponible: true },

            // Snacks
            { id: 14, nombre: 'Croissant', precio: 7.50, categoria: 'Snacks', imagen: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500', stock: 3, disponible: true },
            { id: 15, nombre: 'Muffin de Arándanos', precio: 6.80, categoria: 'Snacks', imagen: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500', stock: 2, disponible: true },
            { id: 16, nombre: 'Galleta de Chocolate', precio: 3.50, categoria: 'Snacks', imagen: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500', stock: 0, disponible: false },
            { id: 17, nombre: 'Sándwich de Pollo', precio: 12.00, categoria: 'Snacks', imagen: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500', stock: 5, disponible: true },
            { id: 18, nombre: 'Empanada de Carne', precio: 8.50, categoria: 'Snacks', imagen: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=500', stock: 7, disponible: true },

            // Café Premium
            { id: 8, nombre: 'Caramel Macchiato', precio: 8.50, categoria: 'Café Premium', imagen: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=500', stock: 2, disponible: true },
            { id: 19, nombre: 'Mocha Blanco', precio: 9.00, categoria: 'Café Premium', imagen: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=500', stock: 1, disponible: true },

            // Café Frío
            { id: 6, nombre: 'Cold Brew', precio: 8.00, categoria: 'Café Frío', imagen: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500', stock: 4, disponible: true },
            { id: 20, nombre: 'Frappé de Vainilla', precio: 9.50, categoria: 'Café Frío', imagen: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500', stock: 3, disponible: true },
        ]);
    ...
    router.post('/caja/registrar', pedidoData, {
        onSuccess: () => {
            toast.success('✅ Pedido realizado con éxito', {
                description: `Total: S/ ${total.toFixed(2)}`,
                duration: 4000,
                style: {
                    background: '#2D1B1A',
                    color: '#FBF3E7',
        ...
        onError: (errors) => {
            toast.error('Error al registrar pedido: ' + Object.values(errors).join(' '));
        }
    });
};
        ...
        <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-3 sm:p-4 bg-[#FBF7F0]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="lg:col-span-2">
                    ...
                    {/* Categorías - GRID MODERNO 3 COLUMNAS */}
